...
Client = (function() {
  var REQUEST_CHARSET, SERVER_COMMON_PORT, SERVER_NAME, SERVER_PROTO, SERVER_SECURE_PORT;
  ...
  function Client(options) {
    ...
    this._port = (_ref2 = options.port) != null ? _ref2 : this._proto === 'http' ? SERVER_COMMON_PORT : SERVER_SECURE_PORT;
  ...
  Client.prototype.invokeMethod = function(name, input, callback) {
    var Module, blob, fullInput, key, request, value;
    fullInput = Object.create(null);
    fullInput.answer = 'json';
    fullInput.user = this._user;
    ...
    Module = this._proto === 'http' ? HTTP : HTTPS;
    request = Module.request(this._requestOptions(name, blob));
